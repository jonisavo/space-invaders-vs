...
#pragma warning restore 0649
        ...
        {
            for (int printedChars = this.TextComponent.maxVisibleCharacters; printedChars > 0; --printedChars)
            {
                var hiddenChar = this.charactersToType[printedChars - 1];

                float delay = staticDelay >= 0 ? staticDelay : hiddenChar.Delay;
                ...
                this.TextComponent.maxVisibleCharacters = printedChars - 1;
                this.UpdateMeshAndAnims();
            }
        }
